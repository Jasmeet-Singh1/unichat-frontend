...
const UserProfileModal = ({ 
  ...
  const getRoleBadgeClass = (role) => {
    switch (role) {
      ...
      case 'Alumni': return 'alumni-badge';
            ...
            <>
              ...
              <div className="modal-header enhanced-header">
                ...
                <div className="profile-header-info">
                  ...
                  <span className={`profile-role ${getRoleBadgeClass(profile.role)}`}>
                    {profile.role}
                  </span>
                  ...
                  <div className="profile-meta">
                    ...
                    {profile.program && (
                      <p className="profile-program">{profile.program}</p>
                    )}
                    {profile.programType && (
                      <p className="profile-program-type">{profile.programType}</p>
                    )}
                  </div>
                </div>
              </div>
                        ...
                        <div key={index} className="course-item">
                          <div className="course-header">
                            ...
                            {course.semester && course.year && (
                              <span className="course-term">{course.semester} {course.year}</span>
                            )}
                          </div>
                          {course.courseName && (
                            <div className="course-description">{course.courseName}</div>
                          )}
                          {course.instructor && (
                    ...
                    {profile.courseExpertise && profile.courseExpertise.length > 0 && (
                      <div className="subsection">
                        ...
                        <div className="expertise-grid">
                          {profile.courseExpertise.map((expertise, index) => (
                            <div key={index} className="expertise-card">
                              <div className="expertise-header">
                                <span className="course-code">{expertise.course}</span>
                                <span className="course-grade">{expertise.grade}</span>
                              </div>
                              {expertise.courseName && (
                                <div className="expertise-name">{expertise.courseName}</div>
                              )}
                              {expertise.instructor && (
                                <div className="expertise-instructor">Prof. {expertise.instructor}</div>
                              )}
                              {expertise.topicsCovered && expertise.topicsCovered.length > 0 && (
                                <div className="topics-covered">
                                  <strong>Topics:</strong> {expertise.topicsCovered.join(', ')}
                                </div>
                              )}
                            </div>
                          ))}
                    ...
                    <div className="info-cards">
                      {profile.availability && profile.availability.length > 0 && (
                        <div className="info-card full-width">
                          ...
                          <div className="info-value availability-text">{formatAvailability(profile.availability)}</div>
                        </div>
                      )}
                      {profile.overallGPA && (
                        <div className="info-card">
