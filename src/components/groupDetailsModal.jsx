  ...
  return (
    <>
      ...
      <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center z-50'>
        <div className='bg-white rounded-lg p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto thing'>
      ...
      {/* Edit Group Modal */}
      {showEditModal && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex  justify-center z-60'>
          <div className='bg-white rounded-lg p-6 max-w-md w-full mx-4 thing'>
            <div className='flex items-center justify-between mb-4'>
                ...
                <div className='border border-gray-200 rounded-lg max-h-48 overflow-y-auto'>
                  {searchResults.map((user) => (
                    ...
                    >
                      ...
                      <button className='text-blue-500 hover:text-blue-700 text-sm font-medium'>Add</button>
                    </div>
                  ))}
                </div>
              )}
