      ...
      <div style={styles.card}>
        ...
        <div style={styles.post}>
          <h4 style={styles.postTitle}>
            🚀 Internship Opportunity at TechNova
          </h4>
          <p style={styles.postText}>
            We are hiring final-year students for summer internship. Apply
            before July 5!
          </p>
          <a
        ...
        <div style={styles.post}>
          ...
          <p style={styles.postText}>
            As someone who recently transitioned to full-time work, here are a
            few survival tricks that helped me during my studies...
          </p>
          <div style={styles.actions}>
