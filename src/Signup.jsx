  ...
  const addEnrolledCourse = () => {
    ...
    setFormData((prev) => ({
      ...
      enrolledCourses: [
        ...
        { courseCode, courseName, semester, year, instructor },
      ],
      courseCode: "",
      courseName: "",
      semester: "",
                ...
                <div className="form-block">
                  ...
                  <div className="input-group">
                    <label>
                      Select Course*{" "}
                      <span
                        data-tooltip-id="courseCode-tooltip"
                        className="info-icon"
                      >
                        i
                      </span>
                    ...
                    <Tooltip
                      id="courseCode-tooltip"
                      content="Select a course you are enrolled in"
                    />
                    <select
                      name="courseCode"
            ...
            {formData.role === "Student" && step === 6 && (
              <div className="form-block">
                ...
                <div className="input-group">
                  ...
                  <Tooltip
                    id="club-tooltip"
                    content="Select a club you are part of"
                  />
                  <select
                    name="club"
                    value={formData.club || ""}
                  ...
                  <>
                    <div className="input-group">
                      ...
                      <Tooltip
                        ...
                        content="Your role in the selected club"
                      />
                      <select
                        name="designation"
