  ...
  const sendMessage = async (targetUser) => {
    try {
      ...
      if (!currentUserId) {
        ...
        currentUserId =
          localStorage.getItem('userId') || localStorage.getItem('user_id') || localStorage.getItem('id');
      ...
      const messagePayload = {
        chatId: chatId,
        text: `Hi ${
          targetUser.firstName || targetUser.name
        }! I found you through the browse page and would love to connect.`,
        type: 'text',
      };
          ...
          <div className='search-form'>
            ...
            <div className='search-row'>
              <div className='search-group'>
                <label>
                  <span className='emoji'>🔍</span> Search Term
                </label>
                <input
                  type='text'
              ...
              <div className='search-group'>
                <label>
                  <span className='emoji'>📋</span> Search By
                </label>
                <select
            ...
            <div className='search-row'>
              <div className='search-group'>
                <label>
                  <span className='emoji'>👤</span> Role
                </label>
                <select
                  className='search-select'
                  value={filters.role}
              ...
              <div className='search-group'>
                <label>
                  <span className='emoji'>📚</span> Program
                </label>
                <select
                  className='search-select'
              ...
              <div className='search-group'>
                <label>
                  <span className='emoji'>📅</span> Year
                </label>
                <select
                  className='search-select'
                  value={filters.year}
            ...
            <div className='search-row'>
              <div className='search-group'>
                <label>
                  <span className='emoji'>📖</span> Course Code
                </label>
                <select
                  className='search-select'
              ...
              <div className='search-group'>
                <label>
                  <span className='emoji'>📝</span> Course Name
                </label>
                <select
                  className='search-select'
              ...
              {filters.courseCode && filters.courseName && (
                <div className='search-group'>
                  <label>
                    <span className='emoji'>ℹ️</span> Selected Course
                  </label>
              ...
              sortedUsers.map((user) => (
                <div key={user.id} className='user-card'>
                  ...
                  <div className='user-actions'>
                    ...
                    <button className='btn-profile' onClick={() => viewProfile(user.id)}>
                      👤 View Profile
                    </button>
                  </div>
                </div>
